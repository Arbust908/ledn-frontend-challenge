...
> This use the Mantine variables but could be any other library that will standardize the CSS variables across the app. The main point is to have a single source of truth for all the colors, spacing, font sizes, etc. and to be able to easily switch between light and dark color schemes.

## not depending on color scheme
